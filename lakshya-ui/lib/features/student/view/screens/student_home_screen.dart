...
class _StudentHomeScreenState extends ConsumerState<StudentHomeScreen>
  ...
  Widget _buildFooter(BuildContext context, bool isDesktop, bool isTablet) {
    return Container(
      margin: EdgeInsets.only(
        top: isDesktop ? 50 : 40,
                  ...
                  Wrap(
                    ...
                    children: [
                      _buildFooterLink(
                        ...
                        isDesktop,
                        () {
                          // Navigate to aptitude quiz
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Navigating to Aptitude Quiz'),
                      ...
                      _buildFooterLink(
                        ...
                        () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Navigating to Career Roadmap'),
                              behavior: SnackBarBehavior.floating,
                            ),
                          );
                        },
                      ...
                      _buildFooterLink(
                        ...
                        () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Navigating to Colleges'),
                              behavior: SnackBarBehavior.floating,
                            ),
                          );
                        },
                      ...
                      _buildFooterLink(
                        ...
                        () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Navigating to Scholarships'),
                              behavior: SnackBarBehavior.floating,
                            ),
                          );
                        },
